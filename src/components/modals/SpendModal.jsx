...
<form className="grid gap-3 tap-safe" onSubmit={e=>{ e.preventDefault(); onSubmit({ ...form, amount:Number(form.amount||0), type:'expense' }) }}>
<input className="input" type="number" inputMode="decimal" placeholder="Amount" value={form.amount} onChange={e=>setForm(f=>({...f, amount:e.target.value}))} required />
